# A 3-Node Kubernetes Cluster Setup Using kubeadm, kubelet, and kubectl
...
1. Install `kubeadm`, `kubelet`, and `kubectl`
    ...
    * `kubelet`: the component that runs on all nodes in the cluster and does things like starting pods and containers
...
1. (RUN AS ROOT) Create cluster join command:
    ...
    1. 
        ...
        kubeadm join 172.31.33.183:6443 --token h8fcl5.9t0smm8wj72kxcpx --discovery-token-ca-cert-hash sha256:7a0dc12f64375b44dd8edd37e3210a4ca140eb985a99bb87648f01afd0428247
        ```
...
```
sudo kubeadm join 172.31.33.183:6443 --token h8fcl5.9t0smm8wj72kxcpx --discovery-token-ca-cert-hash sha256:7a0dc12f64375b44dd8edd37e3210a4ca140eb985a99bb87648f01afd0428247
```
